      ...
      <div className="PuzzleRealMain">
        <div className="PuzzleMainContainer">
          <ul className="PuzzleContainer">
            <li
              className="Puzzle Puzzle1"
              style={{ ...tileBg, ...this.state.showPuzzle.puzzle1 }}
              onClick={() => this.isClickable(1)}
            >
              1
            </li>
            <li
              className="Puzzle Puzzle2"
              style={{ ...tileBg, ...this.state.showPuzzle.puzzle2 }}
              onClick={() => this.isClickable(2)}
            >
              2
            </li>
            <li
              className="Puzzle Puzzle3"
              style={{ ...tileBg, ...this.state.showPuzzle.puzzle3 }}
              onClick={() => this.isClickable(3)}
            >
              3
            </li>
            <li
              className="Puzzle Puzzle4"
              style={{ ...tileBg, ...this.state.showPuzzle.puzzle4 }}
              onClick={() => this.isClickable(4)}
            >
              4
            </li>
            <li
              className="Puzzle Puzzle5"
              style={{ ...tileBg, ...this.state.showPuzzle.puzzle5 }}
              onClick={() => this.isClickable(5)}
            >
              5
            </li>
            <li
              className="Puzzle Puzzle6"
              style={{ ...tileBg, ...this.state.showPuzzle.puzzle6 }}
              onClick={() => this.isClickable(6)}
            >
              6
            </li>
            <li
              className="Puzzle Puzzle7"
              style={{ ...tileBg, ...this.state.showPuzzle.puzzle7 }}
              onClick={() => this.isClickable(7)}
            >
              7
            </li>
            <li
              className="Puzzle Puzzle8"
              style={{ ...tileBg, ...this.state.showPuzzle.puzzle8 }}
        ...
        <button
          ...
          style={{ display: this.state.showPic ? "none" : "block" }}
        >
          Continue Game...
        </button>
        <button
